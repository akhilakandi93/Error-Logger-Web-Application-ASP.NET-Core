...
using AkhilaKandi_FinalProject.Models;
...
namespace AkhilaKandi_FinalProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (!ud.checkIfActive(model.Email))
            {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                  //if(Request.IsAuthenticated && (User.Identity.Name=="akhila@syr.edu" || User.Identity.Name == "abhi@syr.edu"))
                  //  {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ud.lastLoggedTime = System.DateTime.Now;
